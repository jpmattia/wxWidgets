...
// MESSAGE_ITERATIONS sets the number of iterations. If the number of
// MESSAGE_ITERATIONS is much beyond 200 for stress-testing, then the wait
// times should likely also be increased. Search for "wait a maximum" in
// ipc.cpp and sckipc_server to find those values.
